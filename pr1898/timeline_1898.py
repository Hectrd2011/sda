...
LABELS = [
    dict(name="Spanish forces", hint=[("1898-05-10", (-66.25, 18.36))],
         army=[("1898-05-10", 17_000), ("1898-07-25", 17_000), ("1898-08-13", 15_800), ("1898-10-17", 9_000),
               ("1898-10-18 12:00", 0)]),
    dict(name="Miles's expedition", hint=[("1898-07-25", (-66.93, 17.9)), ("1898-07-28 12:00", (-66.62, 17.93))],
         army=[("1898-07-25 06:00", 3_400), ("1898-07-28", 3_400), ("1898-07-31", 7_000),
               ("1898-08-01 12:00", 7_000), ("1898-08-01 13:00", 0)]),
    dict(name="Wilson's column", hint=[("1898-08-01", (-66.56, 17.95)), ("1898-08-09 12:00", (-66.42, 17.93)),
                                       ("1898-08-12", (-66.42, 17.93))],
         army=[("1898-08-01 12:00", 3_200), ("1898-08-13 12:00", 3_200), ("1898-10-18", 3_000)]),
    dict(name="Brooke's column", hint=[("1898-08-01", (-66.0, 17.89)), ("1898-08-05", (-66.0, 17.89)),
                                       ("1898-08-13", (-66.0, 17.89))],
         army=[("1898-08-01 16:00", 1_600), ("1898-08-03", 5_000), ("1898-10-18", 5_000)]),
    dict(name="Schwan's column", hint=[("1898-08-09", (-66.93, 17.97)), ("1898-08-10 12:00", (-67.05, 18.03)),
                                       ("1898-08-11 16:00", (-67.22, 18.17)), ("1898-08-13", (-67.2, 18.2))],
         army=[("1898-08-09 06:00", 1_450), ("1898-10-18", 1_450)]),
    dict(name="Henry's column", hint=[("1898-08-06", (-66.66, 18.1)), ("1898-08-10", (-66.79, 18.17)),
                                      ("1898-08-13", (-66.78, 18.27))],
         army=[("1898-08-06", 2_800), ("1898-10-18", 2_800)]),
    dict(name="Spanish at Aibonito and Asomante", hint=[("1898-08-02", (-66.24, 18.18))],
         army=[("1898-08-02", 1_300), ("1898-10-17", 1_300), ("1898-10-18", 0)]),
    dict(name="Spanish in the west (Mayaguez)", hint=[("1898-07-26", (-67.02, 18.19)),
                                                      ("1898-08-11 16:00", (-66.93, 18.34))],
